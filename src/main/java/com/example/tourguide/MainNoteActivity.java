...
public class MainNoteActivity extends AppCompatActivity {
    ...
    private void setInsertButton() {
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText line1 = findViewById(R.id.edit_text_line_1);
                EditText line2 = findViewById(R.id.edit_text_line_2);
    ...
    private class ExampleAdapter extends RecyclerView.Adapter {
