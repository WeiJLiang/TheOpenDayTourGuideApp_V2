        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        {
            ...
            registerBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    RadioButton selected_userType = radioGroup.findViewById(checkedId);
                    if (selected_userType == null) {
                        Toast.makeText(RegisterActivity.this, "Select user please", Toast.LENGTH_SHORT).show();
                    } else {
                        final String userType = selected_userType.getText().toString();
                        if (TextUtils.isEmpty(user_name) || TextUtils.isEmpty(email) || TextUtils.isEmpty(txt_password) ||
                            ...
                            register(user_name, email, txt_password, txt_mobile, userType);
                        }
                    }

                }

                private void register(final String user_name, final String email, final String txt_password, final String txt_mobile, final String userType) {
